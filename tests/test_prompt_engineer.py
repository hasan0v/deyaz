...
from work_modes import mode, uses_project_context
...
class PromptEngineerSafetyTests(unittest.TestCase):
    def test_prompt_engineer_disables_detected_project_context(self):
    ...
    def test_prompt_contains_no_guessing_contract(self):
        ...
        self.assertIn("only source of concrete facts", prompt)
    ...
    def test_pipeline_does_not_send_detected_stack_to_prompt_engineer(
