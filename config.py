...
def _storage_root(variable, fallback):
    return pathlib.Path(os.environ.get(variable) or os.path.expanduser(fallback))
...
DEFAULTS = {
    ...
    "file_last_dir": "",
    "file_language": "auto",        # auto | az | en | tr
